...
export const Footer = () => {
  return (
    <footer className="bg-linear-to-r from-cyan-100 via-blue-300 to-indigo-400">
  <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8 ">
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3 ">
      <div>
        <div className="block text-cyan-900 font-bold text-3xl">
          <a href="#">MY WEBSITE</a>
        </div>
        ...
        <ul className="mt-8 flex gap-6">
          <li>
            <a
              ...
              rel="noreferrer"
              target="_blank"
              className="text-cyan-900 transition hover:opacity-75"
            >
